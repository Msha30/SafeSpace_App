...
class AppPrivacyPolicy : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_app_privacy_policy, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up real-time listener for Privacy Policy
    ...
    private fun setupFirestoreListener() {
        ...
        listenerRegistration = db.collection("TermsAndPrivacy")
            ...
            .addSnapshotListener { snapshot, error ->
                ...
                if (error != null) {
                    // Handle error
                    contentTextView.text = "Error loading privacy policy. Please try again later."
