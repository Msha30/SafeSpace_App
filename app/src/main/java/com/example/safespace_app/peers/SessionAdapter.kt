...
class SessionsAdapter(
    private val sessions: List<ActiveSession>,
    private val onClick: (ActiveSession) -> Unit
    ...
    override fun onBindViewHolder(holder: SessionViewHolder, position: Int) {
        ...
        holder.name.text = session.studentName
        ...
        Glide.with(holder.itemView.context)
            .load(if (session.studentPhoto.isEmpty()) R.drawable.img_placeholder else session.studentPhoto)
